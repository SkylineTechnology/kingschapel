...
if (isset($_GET['del_id'])) {
    ...
    $delete_HOD = mysqli_query($conn, "DELETE FROM members WHERE memberid = '$id'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <?php                                    
                                    $members_num = mysqli_num_rows(mysqli_query($conn, "select * from members where dept='$hodDept'"));
                                    ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    $new_members = mysqli_num_rows(mysqli_query($conn, "select * from members where dept='$hodDept' and date > '$new_members_date_range'"));
                                    ?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body" style="overflow-x: scroll;">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($conn, "select * from members where dept='$hodDept'");
                                            $a = 1;
                                            while ($row = mysqli_fetch_array($result)) {
                                                $did = $row["dept"];
                                                $department_name = mysqli_fetch_array(mysqli_query($conn, "select * from department where dept_id='$did'"));
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editmembers.php?m=<?php echo base64_encode($row["memberid"]); ?>">UPDATE</a> |
                                                        <a href="view.php?del_id=<?php echo $row['memberid']; ?>">DELETE</a>
                                                    </td>
                                                </tr>
    <?php
    $a++;
